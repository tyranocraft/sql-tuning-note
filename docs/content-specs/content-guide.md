...
- **기초 이론은 온전히 다룬다.** EXPLAIN, B-Tree 등 이후 토픽의 전제가 되는 기초 이론 토픽은 해당 주제를 빠짐없이 다룬다. "시나리오 중심"은 기초 이론을 시나리오에 필요한 만큼만 잘라 넣으라는 뜻이 아니라, 장황한 교과서식 서술을 피하라는 원칙이다. 온전한 기초 이론 위에 시나리오가 쌓여야 학습자가 응용할 수 있다.
